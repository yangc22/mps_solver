...
for i = 1 : nu
    figure();
    plot(t_span(1 : end), sol_z(1 : end, i));
    legend(['u_', num2str(i)]);
    xlabel('Time');
    ylabel('Control');
    grid on
...
for i = 1 : nd
    figure();
    plot(t_span(1 : end), sol_z(1 : end, nu + i));
...
for i = 1 : ns
    figure();
    plot(t_span(1 : end), sol_z(1 : end, nu + nd + i));
...
for i = 1 : nd
    figure();
    plot(t_span(1 : end), sol_z(1 : end, nu + nd + ns + i));
    legend(['v_', num2str(i)]);
    xlabel('Time');
    ylabel('Lagrange Parameter w.r.t CVIC');
    grid on
...
for i = 1 : ns
    figure();
    plot(t_span(1 : end), sol_z(1 : end, nu + 2 * nd + ns + i));
...
[h_y,h_z,h_p,g_y,g_z,g_p] = difference_DAE(x0, p, alpha0);
